...
The spec is currently in https://docs.google.com/document/d/1s-GeH5XpHBLzbQZucA8DPA7vvF7Xvf_nrPbrU2YLBcE/edit?usp=sharing[[.underline]#Google doc form#], but will move to adoc (in this repo) shortly.
